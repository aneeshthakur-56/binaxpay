        ...
        <div className="modal fade show d-block" tabIndex="-1">
          ...
          <div className="modal-dialog modal-dialog-centered">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 data-aos="fade-right" class="aos-init aos-animate">Api Keys</h2>
                <div class="d-flex">
                    <button class="btn btn-sm btn-outline-primary me-2" onClick={() => setShowModal(true)}>
                        <i class="fas fa-plus me-1"></i> <span class="d-none d-md-inline">Create New</span>
                    </button> 
                </div>
            </div>
            <div class="card">
